...
func TestAccServiceDataSource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccServiceDataSourceDeploymentOnlyConfig(projectName, deploymentName),
			},
			{
...
func testAccServiceDataSourceDeploymentOnlyConfig(projectName, deploymentName string) string {
	return fmt.Sprintf(`
