...
const testUnitProjectEnvVarAPIResponse = `{"id":"33333333-3333-3333-3333-333333333333","name":"unit-test-var","secret":false}`

func testUnitProjectEnvVarResourceConfig(baseURL, value string) string {
...
func TestUnitProjectEnvironmentVariableResource_CreateError(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testUnitProjectEnvVarResourceConfig(baseURL, "initial-value"),
...
func TestUnitProjectEnvironmentVariableResource_ReadError(t *testing.T) {
	baseURL, get, post, _, del := testUnitMockServer(t)
	post.set(testUnitJSON(201, testUnitProjectEnvVarAPIResponse))
	get.set(testUnitJSON(200, testUnitProjectEnvVarAPIResponse))
...
func TestUnitProjectEnvironmentVariableResource_ReadNotFoundDrift(t *testing.T) {
	baseURL, get, post, _, del := testUnitMockServer(t)
	post.set(testUnitJSON(201, testUnitProjectEnvVarAPIResponse))
	get.set(testUnitJSON(200, testUnitProjectEnvVarAPIResponse))
	del.set(testUnitNoContent())
...
func TestUnitProjectEnvironmentVariableResource_UpdateError(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Config:      testUnitProjectEnvVarResourceConfig(baseURL, "updated-value"),
...
func TestUnitProjectEnvironmentVariableResource_DeleteError(t *testing.T) {
	baseURL, get, post, _, del := testUnitMockServer(t)
	post.set(testUnitJSON(201, testUnitProjectEnvVarAPIResponse))
	get.set(testUnitJSON(200, testUnitProjectEnvVarAPIResponse))
